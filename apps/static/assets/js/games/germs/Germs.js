...
export default class Germs extends Phaser.Physics.Arcade.Group
{
    constructor (world, scene)
    {
        ...
        this.germConfig = [
            { animation: 'germ1', speed: 120 },
            { animation: 'germ2', speed: 180 },
            { animation: 'germ3', speed: 240 },
            { animation: 'germ4', speed: 360 }
        ];
    }
    ...
    start ()
    {
        ...
        this.timedEvent = this.scene.time.addEvent({ delay: 1000, callback: this.releaseGerm, callbackScope: this, loop: true });
    }
